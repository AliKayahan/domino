...
//    System.out.println("Serial number " + Special.getStamp());
    ...
    while (_$_ != ZERO) {
      ...
      switch (_$_) {
      case 5:
        int index = (int) (Math.random() * (Didcot.raccoon.length / 3));
        String what = Didcot.raccoon[index * 3];
        String who = Didcot.raccoon[1 + index * 3];
      ...
      case 3: {
        ...
        JFrame f = new JFrame("Rules by Cumali Kayahan");
